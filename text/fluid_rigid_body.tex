...
\begin{align}
        ...
        \rhof \left[  \frac{\vfr^{n, \, \alpha} - \vfr^{n-1,\, \alpha}}{\deltat} + \frac{3}{2} ( \vfr^{n-1,\, \gamma}  -  \dot{u}^{n-1,\, \gamma}) \, G_{\beta \gamma}(\bu^{n-1}) \frac{\partial  \vfr^{n-1, \, \alpha}}{\partial \xr^\beta} - \frac{1}{2} ( \vfr^{n-2,\, \gamma}  -  \dot{u}^{n-2,\, \gamma}) \, G_{\beta \gamma}(\bu^{n-2}) \frac{\partial  \vfr^{n-2, \, \alpha}}{\partial \xr^\beta} \right] & =              \newlinenn
...
\begin{enumerate}
        ...
        \titleditem{Pressure correction}{
                ...
                \ee
                Multiplying \cref{eq_phi_1} by $G_{\gamma \alpha}(\bu^{n-1}) \hat{n}^{\reference\, \gamma}$, where $\hat{\bm n}^{\reference}$ is the boundary normal in the \ac{ref} configuration,  we obtain
                \begin{align}
                        \label{eq_phi_2}
                        \frac{\rhof}{\deltat} G_{\gamma \alpha}(\bu^{n-1}) \hat{n}^{\reference\, \gamma} (\vbar^\alpha - \vfr^{n, \, \alpha}) & = \newlinenn
                        \hat{n}^{\reference\, \gamma} G_{\gamma \alpha}(\bu^{n-1})  G_{\beta \alpha}(\bu^{n-1})  \,          \pderr{ \phi   }{\beta }.
                \end{align}
