...
\pder{\Sdom_{\alpha \beta}(\bu)}{\xr^\beta} = 0 \text{ in } \omr,
\ee
...
\begin{align}
        ...
        \pder{}{\xr^\beta}\der{\Sdom_{\alpha \beta}(\bu)}{t} & = 0 \text{ in } \omr,                                                                  \\
        \label{bc_ela_1_dot}
...
\begin{align}
        ...
        \pder{\Sdom_{\alpha \beta}(\bu^n)}{\xr^\beta} & = 0 \text{ in } \omr,                                                                            \\
        \label{bc_ela_1_disc}
...
\begin{align}
        ...
        \pder{}{\xr^\beta}\der{\Sdom_{\alpha \beta}(\budot^n)}{t} & = 0 \text{ in } \omr,                                                                  \\
