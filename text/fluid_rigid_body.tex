...
\begin{align}
        ...
        I \der{\omega}{t} & =                                               \newlinenn
        \int_\pomellipseeqr \dint{s} \, \epsilon_{\alpha \beta} \left[ \varphi^{\alpha, \, t}(\bxi{s}) - \focalpoint^\alpha \right] \sigmastressr_{\beta \gamma}(\bxi{s}) \epsilon_{\gamma \lambda} F_{\lambda \mu}(\bu^t(\bxi{s})) \der{\xi^\mu(s)}{s}
\end{align}
\ew
...
\begin{align}
        ...
        =                                            & \sigmafr(\bxr, t) \delta_{\alpha \beta} + \etaf \Big[ G_{\gamma \beta}(\bu^t(\bxr)) \pderr{\vfc^\alpha}{\gamma} + \newlinenn
                                                     & G_{\gamma \alpha}(\bu^t(\bxr)) \pderr{\vfc^\beta}{\gamma}\Big],
\end{align}
where
\be
\label{eq_def_G}
...
\begin{align}
        ...
        \rhof \left\{ \pder{ \vfr^\alpha(\bxr, t)}{t} + \left[ \vfr^\gamma(\bxr, t)  - \der{\varphi^{\gamma\, t}(\bxr)}{t}\right]  G_{\beta \gamma}(\bu^t(\bxr)) \frac{\partial  \vfr^\alpha(\bxr, t)}{\partial \xr^\beta} \right\}                                                 & =              \newlinenn
        G_{\beta \alpha}(\bu^t(\bxr))  \,          \pderr{ \sigmafr(\bxr, t)   }{\beta }                + \etaf \,              G_{\delta \beta}(\bu^t(\bxr))           \,         \pderr{}{\delta} \left[  G_{\gamma \beta}(\bu^t(\bxr)) \pderr{ \vfr(\bxr, t)}{\gamma}   \right], &                           \\
        \label{eq_fl_rigid_fl_2_reference}
        G_{\beta \alpha}(\bu^t(\bxr)) \pderr{ \vfr^\alpha(\bxr, t)}{\beta}                                                                                                                                                                                                          & = 0,
\end{align}
\ew
which hold in $\omr$.
...
\begin{align}
        ...
        \etaf G_{\beta 1}(\bu^t(\bxr)) \pderr{ \vfr^\alpha}{\beta} & = 0  \; \text{ on } \pomouteqr ,                                                                       \\
...
The equations of motion \crefs{\eqsfluidbodyref} involve the displacement field $\bm u$, which describes how the region, or domain, where \ac{bflu} sits, is deformed in time, cf. \cref{fig_ref_curr_rigid}. We will denote this region as the  \ac{dom}.
...
\begin{align}
        ...
        I  \int_\pomellipseeqr \dint{s} \, \epsilon_{\alpha \beta} \left[ \xi^\alpha(s) + u^{n-1,\, \alpha}(\bxi{s})- \focalpoint^\alpha \right]                                                                             \sigmastressr^{n-1}_{\beta \gamma}(\bxi{s}; {\bm \vfr^{n-1}, \sigmafr^{n-3/2}}) \times \newlinenn
                                                      & \epsilon_{\gamma \lambda} F_{\lambda \mu}(\bu^{n-1}(\bxi{s})) \der{\xi^\mu(s)} {s}  ,
\end{align}
\ew
...
\begin{align}
        ...
        \rhof \Bigg[  \frac{\vfr^{n, \, \alpha} - \vfr^{n-1,\, \alpha}}{\deltat} + \frac{3}{2} ( \vfr^{n-1,\, \gamma}  -  \dot{u}^{n-1,\, \gamma}) \, G_{\beta \gamma}(\bu^{n-1}) \frac{\partial  \vfr^{n-1, \, \alpha}}{\partial \xr^\beta} -
        \frac{1}{2} ( \vfr^{n-2,\, \gamma}  -  \dot{u}^{n-2,\, \gamma}) \times                                                                                                                                                                                                                                                     & \newlinenn
        G_{\beta \gamma}(\bu^{n-2}) \frac{\partial  \vfr^{n-2, \, \alpha}}{\partial \xr^\beta} \Bigg]                                                                                                                                                                                                                              & =              \newlinenn
        G_{\beta \alpha}(\bu^{n-1})  \,          \pderr{ \sigmafr^{n-1/2}   }{\beta }                + \etaf \,              G_{\delta \beta}(\bu^{n-1})            \,         \pderr{}{\delta} \left[  G_{\gamma \beta}(\bu^{n-1}) \pderr{ }{\gamma}\left(\frac{\vfr^{n, \, \alpha} + \vfr^{n-1, \, \alpha}}{2}\right)   \right], &                           \\
        \label{eq_fl_rigid_fl_2_reference_disc}
        G_{\beta \alpha}(\bu^{n-1}) \pderr{ \vfr^{n-1,\, \alpha}}{\beta}                                                                                                                                                                                                                                                           & = 0,
\end{align}
\ew
...
\begin{align}
        ...
        \etaf \, G_{\beta 1}(\bu^{n-1}) \pderr{}{\beta}\left( \frac{\vfr^{n, \, \alpha} + \vfr^{n-1, \, \alpha}}{2}\right) & = 0                                                                                                           \; \text{ on } \pomouteqr , \\
...
\begin{enumerate}
        \titleditem{Approximated velocity}{
                ...
                \begin{align}
                        ...
                        \rhof \left\{  \frac{\vbar^\alpha - \vfr^{n-1,\, \alpha}}{\deltat} + \left[ \frac{3}{2} ( \vfr^{n-1,\, \gamma}  -  \dot{u}^{n-1,\, \gamma}) \, G_{\beta \gamma}(\bu^{n-1})  - \frac{1}{2} ( \vfr^{n-2,\, \gamma}  -  \dot{u}^{n-2,\, \gamma}) \, G_{\beta \gamma}(\bu^{n-2})  \right] \frac{\partial  V^\alpha}{\partial \xr^\beta}\right\} & =              \newlinenn
                        G_{\beta \alpha}(\bu^{n-1})  \,          \pderr{ \sigmafr^\ast   }{\beta }                + \etaf \,              G_{\delta \beta}(\bu^{n-1})            \,         \pderr{}{\delta} \left(  G_{\gamma \beta}(\bu^{n-1}) \pderr{V^\alpha }{\gamma}    \right),
                \end{align}
                \begin{align}
                        ...
                        \etaf \, G_{\beta 1}(\bu^{n-1}) \pderr{V^\alpha}{\beta} & = 0                                                                                                           \; \text{ on } \pomouteqr.
                \end{align}
                \ew
                where
                \begin{align}
        ...
        \titleditem{Pressure correction}{
                ...
                \be
                \label{eq_phi_1}
                \rhof \frac{\vbar^\alpha - \vfr^{n, \, \alpha}}{\deltat}  = G_{\beta \alpha}(\bu^{n-1})  \,          \pderr{ \phi   }{\beta },
                \ee
                where
                ...
                \ee
                Multiplying \cref{eq_phi_1} by $G_{\gamma \alpha}(\bu^{n-1}) \normalr{\gamma}$, where $\bnormalr$ is the unit boundary normal in the \ac{ref} configuration,  we obtain
                \begin{align}
                        \label{eq_phi_2}
                        \frac{\rhof}{\deltat} G_{\gamma \alpha}(\bu^{n-1}) \normalr{\gamma} (\vbar^\alpha - \vfr^{n, \, \alpha}) & = \newlinenn
                        \normalr{\gamma} G_{\gamma \alpha}(\bu^{n-1})  G_{\beta \alpha}(\bu^{n-1})  \,          \pderr{ \phi   }{\beta }.
                \end{align}
...
\begin{enumerate}
        ...
        \titleditem{Update \ac{dom}}{ \label{fl_rigid_step_2}
                Solve  the \acp{bvp} \crefs{eq_mesh_fluid_rigid_disc,bc_ela_1_disc,bc_ela_2_disc,eq_mesh_fluid_rigid_disc_dot,bc_ela_1_disc_dot,bc_ela_2_disc_dot} for $\budom^n$ and $\budomdot^n$.
        }
