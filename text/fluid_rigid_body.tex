...
\be\label{eq_def_u}
\budom^t(\bxr) \equiv \bxdomc - \bxdomr.
\ee
%sign
and the deformation-gradient tensor
\be
\label{eq_def_F}
\Fdom_{\alpha \beta}(\bu) \equiv \delta_{\alpha \beta} + \pderr{u^ \alpha}{\beta},
\ee
%sign_redefine_F
where we set
...
\begin{enumerate}
        \titleditem{Approximated velocity}{
                ...
                \begin{align}
                        ...
                        \rhof \left\{  \frac{\vbar^\alpha - \vfr^{n-1,\, \alpha}}{\deltat} + \left[ \frac{3}{2} ( \vfr^{n-1,\, \gamma}  -  \dot{u}^{n-1,\, \gamma}) \, G_{\beta \gamma}(\budom^{n-1})  - \frac{1}{2} ( \vfr^{n-2,\, \gamma}  -  \dot{u}^{n-2,\, \gamma}) \, G_{\beta \gamma}(\budom^{n-2})  \right] \frac{\partial  V^\alpha}{\partial \xr^\beta}\right\} & =              \newlinenn
        ...
        \titleditem{Pressure correction}{
                ...
                \be
                \label{eq_phi_1}
                \rhof \frac{\vbar^\alpha - \vfr^{n, \, \alpha}}{\deltat}  = G_{\beta \alpha}(\budom^{n-1})         \pderr{ \phi   }{\beta } \text{ in } \omr,
                \ee
                where
                ...
                \begin{align}
                        ...
                        \frac{\rhof}{\deltat} G_{\gamma \alpha}(\budom^{n-1}) \pderr{\vbar^\alpha }{\gamma}                                                 & = \newlinenn
