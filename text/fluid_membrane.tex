...
The \ac{bflu} parameters are $\rhof = 1 \, \kg/\met^3$, $\etaf = 10^{-3} \, \kg/(\met \, \sec)$,  $\sigmafbottomc = - 1 \, \newt / \met^2$, and $\vfbottom^1 =0$, $\vfbottom^2(\bxc) =  \frac{3}{2}  \xc^1 (2 L -\xc^1) v_0$, where $v_0 = 10^{-1}  \, \met / \sec$, and $\vfbottom^2$ corresponds to a Poiseuille flow \cite{landauFluidMechanics1987}.  Finally, the \ac{dom} exponent is $\zeta = 3$.
