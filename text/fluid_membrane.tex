...
An example of this dynamics is shown in \cref{fig_fluid_mem}, for a macroscopic channel with dimensions $L = 1 \, \met$, $h = 0.2 \, \met$. The \ac{mem} parameters are $\kap = 10^{-3} \, \kg \, \met^2/\sec^2$, $\rhom = 1 \, \kg/\met$,  $\etam = 1 \, \kg/\sec $, and $\sigmaml = 1 \, \newt / \met$.
The \ac{bflu} parameters are $\rhof = 1 \, \kg/\met^3$, $\etaf = 10^{-3} \, \kg/(\met \, \sec)$,  $\sigmafbottomc = - 1 \, \newt / \met^2$, and $\vfbottom^1 =0$, $\vfbottom^2 =  \frac{3}{2}  \xcoord^1 (2 L -\xcoord^1) v_0$, where $v_0 = 10^{-1}  \, \met / \sec$, and $\vfbottom^2$ corresponds to a Poiseuille flow \cite{landauFluidMechanics1987}.  Finally, the \ac{dom} exponent is $\zeta = 3$.
