...
\begin{itemize}
    ...
    \titleditem{Update \ac{dom}}{ \label{fl_mem_step_2}
        We determine the \ac{dom} displacement field $\budom, \budomdot$ from the \ac{bvp} \crefs{eq_domain_fluid_rigid_disc,eq_domain_fluid_rigid_disc_dot}, with \acp{bc} given by the discrete version of \cref{bc_fl_mem_dom_1,bc_fl_mem_dom_2,bc_fl_mem_dom_3,bc_fl_mem_dom_4,bc_fl_mem_dom_5,bc_fl_mem_dom_6,bc_fl_mem_dom_7,bc_fl_mem_dom_8}:
        \begin{align}
    ...
    \titleditem{Update \ac{bflu}}{ \label{fl_mem_step_3}
        We determine the \ac{bflu} fields by solving the \ac{bvp} \crefs{eq_fl_rigid_fl_1_reference_disc_aux,eq_poiss_like_phi} with \acp{bc}
        ...
        \begin{align}
            ...
            \sigmafc                                        & = \sigmafbottomc \text{ on } \pombottomeqr.
        \end{align}

        and by \cref{eq_phi_1}.
    }
