...
\begin{figure*}
    ...
    \caption{
        ...
        \plab{A} Membrane \acf{ref} and \acf{cur} configuration (red and green curve, respectively), and displacement field (black arrows).
...
\begin{itemize}
    ...
    \titleditem{Update \ac{bflu}}{ \label{fl_mem_step_3}
        ...
        \begin{align}
            ...
            \bvbarf                                         & =  {\bm v}_\ast  \text{ on } \pombottomeqr, \\
...
An example of this dynamics is shown in \cref{fig_fluid_mem}.
%sign
