...
\begin{itemize}
    ...
    \titleditem{Update \ac{bflu}}{ \label{fl_mem_step_3}
        We determine the \ac{bflu} fields $\bvbarf $ and $\sigmafr^\nmhalf$ by solving the \acp{pde}
        % 
        \bw
        \begin{align}
        ...
        \end{align}
        The \acp{bc} for \cref{eq_fl_rigid_fl_1_reference_disc_aux,eq_poiss_like_phi} are
        \begin{align}
