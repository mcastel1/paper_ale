...
\begin{enumerate}
    \titleditem{Approximated velocities}{
        ...
        Proceeding along the lines of the splitting scheme for  \ac{bflu} of \cref{sec_splitting_scheme_fl_rig_fl}, we introduce some auxiliary  velocities $\bvbar^i$ and $\wbar$, which approximate, respectively, $\vmem^i$ and $\wmem$ \cite{chorinNumericalSolutionNavierStokes1968}. We define $\vbar$ and $\wbar$ as solutions of the \acp{pde}
        \bw
        \begin{align}
...
\begin{itemize}
    \titleditem{Update \ac{mem}}{ \label{fl_mem_step_1}
        ...
        We   solve the \ac{bvp} given by \cref{eq_fl_mem_mem_disc_1,eq_fl_mem_mem_disc_2,eq_fl_mem_mem_disc_4,eq_fl_mem_mem_disc_5}, and
        \begin{align}
