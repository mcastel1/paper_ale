...
We will now discuss each line in \cref{eq-dyn-continuity,eq-dyn-v,eq-dyn-w,eq-dyn-dX,eq-dyn-dX1,eq-dyn-dX2}.
% 
...
\begin{align}
        ...
        \fmemt^i(\vmem, \wmem,\sigmam,\nu,\psi)             & \equiv - \nab_j \Pi^{ij}(\vmem, \wmem,\sigmam,\nu,\psi) \newlinenn
                                                            & = \nab^i \sigmam + \fetamt^i(\vmem, \wmem,\nu,\psi),                              \\
        \label{eq_def_Pi}
...
\end{align}
\ew
In particular, in \cref{eq_def_d}, $d$ is the rate-of-deformation tensor \cite{al-izziShearDrivenInstabilitiesMembrane2020}, and $b$ the second fundamental form \cite{marchiafavaAppuntiDiGeometria2005,desernoNotesDifferentialGeometry2004}.
% 

First, $\rhom$, $\sigmam$, $\etam$ and $\kappa$ are, respectively, the density, line tension, viscosity, and bending rigidity of \ac{mem}.
...
\begin{enumerate}[label=\currentsec.\arabic*]
        \titleditem{Approximated velocities}{
                ...
                \begin{align}
                        ...
                        \nab^{\nmhalf, \, i} \sigmamast     +         \fetamt^i\left( \bVmem, \Wmem, \nu^\nmhalf, \psi^\nmhalf\right) + \newlinenn
