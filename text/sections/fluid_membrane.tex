...
\subsubsection{Equations of motion in  \acl{cur} configuration coordinates}
...
\subsubsection{Equations of motion in  \acl{ref} configuration coordinates}
...
\subsection{Temporal discretization}\label{sec_temp_discretization_mem}
...
\subsubsection{\Acl{mem}}\label{sec_temp_discretization_mem_mem}
\subsubsection{\Acl{dom}}\label{sec_temp_discretization_mem_dom}
\subsubsection{\Acl{bflu}}\label{sec_temp_discretization_mem_bflu}
...
\begin{itemize}
    \titleditem{Update \ac{mem}}{ \label{fl_mem_step_1}
        We introduce the auxiliary quantities \cite{worthmullerIRENEFluIdLayeR2025}
        \begin{align}
            \label{eq_def_Vmem}
    ...
    \titleditem{Update \ac{bflu}}{ \label{fl_mem_step_3}
        ...
        and
        \crefs{eq_poiss_like_phi} with \acp{bc}
