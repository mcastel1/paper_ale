...
Given a \ac{ela} Poisson ratio \cite{landauTheoryElasticity1986} of $\poissonratio \sim 0.49$ \cite{chippadaSimultaneousDeterminationYoungs2010}, we obtain $K \sim 5 \times 10^2 \, \kg/\sec^2$ from the relation $K = 2 \mu(1+\poissonratio)/[3(2\poissonratio-1)]$ \cite{landauTheoryElasticity1986}.
