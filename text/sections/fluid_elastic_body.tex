\subsection{\Acl{bflu} and \acl{ela}}\label{sec_fl_elastic}

In this Section, we will build on the analysis of \cref{sec_fl_rigid} and put \ac{bflu} into interaction with a more complex physical object---an \acf{ela}; only the main results will be presented here.
