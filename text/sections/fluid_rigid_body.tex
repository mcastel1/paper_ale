...
Details on the motion of \ac{bflu} can be found in \cref{sec_rigid_body_fl}.
Details on the motion of \ac{dom} can be found in \cref{sec_eq_fluid_domain}.
Details on the temporal discretization can be found in \cref{sec_temp_discretization}.
