...
\end{align}
and they hold for $\xc \in \omc$.
Here, $\sigmafc$ is the \ac{bflu} surface tension in  \ac{cur} coordinates.
\Cref{eq_fl_rigid_fl_1_current,eq_fl_rigid_fl_2_current} are the \ac{ns} and continuity equations, respectively, in a flat, two-dimensional geometry \cite{landauFluidMechanics1987}---an example of the \ac{ns} equations on curved geometry will be presented in \cref{sec_fl_mem_mem}.
