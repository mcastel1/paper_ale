...
\be
\rhoela \dern{\uela^\alpha(\bxr)}{t}{2} = \pderr{P_{\alpha \beta}(\buela)}{\beta},
\ee
where $\buela$ and $\Sela$ and  $\rhoela$ are, respectively, the deformation field, stress tensor and density  of \ac{ela}; the latter is  assumed to be independent of space.
