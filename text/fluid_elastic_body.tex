...
\begin{itemize}
        ...
        \titleditem{Update \ac{dom}}{ \label{fl_ela_step_2}
                Solve  the \acp{bvp} \crefs{eq_domain_fluid_rigid_disc,eq_domain_fluid_rigid_disc_dot} for $\budom^n$ and $\budomdot^n$, with \acp{bc} \crefs{bc_ela_1_disc,bc_ela_1_disc_dot}
        }
