...
\begin{figure*}
        ...
        \caption{
                \label{fig_fluid_ela}
                Interaction between a \acl{bflu} and an \acl{ela} (a hydrogel). The notation is the same as in \cref{fig_fluid_rigid}, and the \acl{ela} is depicted as a red mesh. Here, the Reynolds number is $R \sim 2 \times 10^2$.
        }
\end{figure*}
