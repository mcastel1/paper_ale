...
\begin{figure*}
    ...
    \caption{
        Interaction between a bulk fluid and a Helfrich membrane. \textbf{A}) Bulk-fluid velocity; the notation is the same as in \cref{fig_fluid_rigid}A. \textbf{B}) Bulk-fluid tension. \textbf{C}), \textbf{D} and \textbf{E}): membrane tangential velocity, normal velocity and tension; the notation is the same as in \cref{fig_mem}B, C and D, respectively.  All panels refer to the same instant of time, shown on top.
        \label{fig_fluid_mem}
    }
\end{figure*}
