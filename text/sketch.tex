\begin{enumerate}
    ...
    \item In this dynamics
          \begin{itemize}
              ...
              \item we show that the derivative of mesh motion $\budomdot$ can be obtained exactly from an auxiliary PDE withotu recurring to error-prone time discretization.
          \end{itemize}
    \item We couple the membrane dynamics to a bulk fluid. The membrane is a complex elastic body -> We proceed by steps:
          \begin{enumerate}[label=\currentsec.\arabic*]
              ...
              \item Bulk fluid + membrane, \cref{fig_fluid_mem_mem}
                    \begin{itemize}
