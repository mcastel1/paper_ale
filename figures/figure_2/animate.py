...
number_of_frames = sysio.count_v_files('line_mesh_n_', plot.snapshot_path)
...
animation.save('animation_large_' + plot.figure_name + '.mp4', dpi=dpi, writer=writer)
